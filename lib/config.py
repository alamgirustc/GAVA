...
__C.DATA_LOADER.GEO_FEATS_FOLDER = 'geo_feats'  # Updated path
...
__C.MODEL.GEO_DIM = 6  # Adding geometric feature dimension

# Add the new dropout key for geometric features
__C.MODEL.DROPOUT_GEO_FEAT = 0.3
...
__C.PARAM.GEO_FEATS = 'GEO_FEATS'  # Add parameter for geometric featuresg
